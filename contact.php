...
<body class="bg-light">
  ...
  <div class="my-5 px-4">
    ...
    <p class="text-center mt-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti, doloremque <br>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-6 col-md-6 mb-5 px-4">
        <div class="bg-white rounded shadow p-4 map">
          <iframe class="w-100 rounded mb-4" height="320px" src="<?php echo $contact_r['iframe'] ?>" loading="lazy"></iframe>
          <h5>Address</h5>
          <a href="<?php echo $contact_r['gmap'] ?>" target="_blank" class="d-inline-block text-decortion-none text-dark mb-2">
          ...
          data
          ?>
          <a href="<?php echo $contact_r['fb'] ?>" class="d-inline-block mb-3 text-dark fs-5">
      ...
      <div class="col-lg-6 col-md-6 mb-5 px-4">
        <div class="bg-white rounded shadow p-4 cont">
          <form method="POST" >
