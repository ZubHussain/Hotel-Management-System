          ...
          <div class="container-fluid flex-lg-column align-items-stretch">
            ...
            <div class="collapse navbar-collapse flex-column align-items-stretch mt-2" id="filterDropdown">
              <div class="border bg-light p-3 rounded mb-3">
                <h5 class="mb-3" style="font-size:18px;">CHECK AVAILAVILITY</h5>
                <label for=class="form-label">Check-in</label>
                <input type="date" class="form-control shadow-none mb-3" aria-describedby="emailHelp">
      ...
      <div class="col-lg-9 col-md-12 px-4">
        <div class="card mb-4 border-0 shadow card">
          <div class="row g-0 p-3 align-items-center">
            ...
            <a href="#" class="btn btn-info w-100 shadow-none mb-2">Book Now</a>
