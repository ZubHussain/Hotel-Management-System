...
?> 
 ...
 <nav id="nav-bar" class="navbar navbar-expand-lg navbar-light bg-white px-lg-3 py-lg-2 shadow-sm sticky-top">
    <div class="container-fluid">
      <a class="navbar-brand me-5 fw-bold fs-3" href="index.html">ZA HOTEL</a>
        ...
        <form>
          <div class="modal-header">
            <h5 class="modal-title d-flex align-items-center">
              <i class="bi bi-person-circle fs-3 me-2"></i> Login Page
            </h5>
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <form>
          ...
          <div class="modal-body">
            <span class="badge rounded-pill bg-light text-dark mb-3 text-rap lh-base">Note: Your details must watch with
              your ID(Aadhar card,Driving licence,Voter ID,Passport etc) that willl be required during checking</span>
            <div class="container-fluid">
              <div class="row">
                ...
                <div class="col-md-6 ps-0">
                  ...
                  <input type="pasword" class="form-control shadow-none" aria-describedby="emailHelp">
                </div>
